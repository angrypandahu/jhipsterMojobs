...
public class JhipsterMojobsApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterMojobsApp.class);

    private final Environment env;

    public JhipsterMojobsApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterMojobs.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterMojobsApp.class);
